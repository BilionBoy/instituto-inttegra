  ...
  return (
    <header
      className={`w-full fixed top-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-[#0a0a0a]/80 backdrop-blur-md shadow-md py-3"
          : "bg-transparent py-5"
      }`}
    >
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <Link href="/" className="flex items-center">
          <span className="text-xl font-light tracking-wider text-white">
            INSTITUTO{" "}
            <span className="font-medium text-[#d4af37]">INTTEGRA</span>
          </span>
        </Link>

        <nav className="hidden md:flex items-center space-x-10">
          <Link
            href="/instituo-inttegra"
          ...
          <Sheet>
            ...
            <SheetContent className="bg-[#0a0a0a] text-white border-[#d4af37]/20">
              <div className="flex flex-col space-y-4 mt-8">
                <Link
                  href="/sobre"
                  className="text-lg font-medium py-2 hover:text-[#d4af37]"
                >
                  Sobre
                </Link>
                <Link
